...
from model.domain.auth import PasswordModel, Token, TokenData
from model.schemas.auth import SignInRequest, UserActiveRequest
...
async def get_current_active_user(current_user: UserActiveRequest = Depends(get_current_user)):
